...
if(language == "fi-FI"){
    var projectDashboardAppDB = {
            ...
            'widget7'      : {
                ...
                'schedule'    : {
                    'T' : [
                        {
                            'id'   : 1,
                            'title': 'Ryhmätapaaminen',
                            'time' : '32 minuutin päästä'
                        },
                        {
                            'id'   : 2,
                            'title': 'Kahvitauko',
                    ...
                    'TM': [
                        ...
                        {
                            'id'   : 4,
                            'title': 'Tapaaminen beta testaajien kanssa',
                            'time' : '15:00 AM'
                        }
                    ]
                }
        ...
        projects: [
            {
                'id'  : 1,
                'name': 'Sitro. Backend App'
            },
            {
                'id'  : 2,
                'name': 'Sitro. Frontend App'
            },
            {
                'id'  : 3,
                'name': 'Creapond'
